...
<body class="main-bg">
    <div class="login-container text-c animated flipInX">
        <div>
            ...
            <h3 class="text-whitesmoke">Sign In To the Dashboard</h3>
            <p class="text-whitesmoke">Sign In</p>
        <div class="container-content">
            <form class="margin-t" action="{{ route('login.post') }}" method="post">
                @csrf
            ...
            <p class="margin-t text-whitesmoke"><small> MD WASIM &copy; 2021</small> </p>
        </div>
    </div>
</body>
</html>
